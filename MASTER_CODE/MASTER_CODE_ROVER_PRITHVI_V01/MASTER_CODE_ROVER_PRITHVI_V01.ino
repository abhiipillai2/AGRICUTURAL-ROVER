/*Internal Audit
-------------------------------------------------
modules we integareted in MASTER_CODE_ROVER_PRITHVI_V01
  1)BOT_GYROSCOPE_V01
  2)BOT_LEFT_ROTATOR_V02
  3)BOT_RIGHT_ROTATOR_V02
  4)BOT_MARGIN_FIXER_V01
  5)BOT_CENTROID_FINDER_V01
  6)BOT_CORNER_FIXER_V01 
  7)BOT_INTEGRATOR_V02 
  8)BOT_LOADER_V02
------------------------------------------------*/
...
//------------------------------------------------setup-------------------------
//here we run our setup algorithm codes
if(setup_flag){
...
//------------------------------------------------loop---------------------------
//here we run our loop/process algorithm codes
if(process_flag){
...
void bot_centroid_finder(){
  ...
  if (!(coordinate >= 185 && coordinate <= 230)){
          ...
          while(loop_flag){
            ...
            if( coordinate > 180 && coordinate < 230 ){
  ...
  if( Y_PING_DISTACE > YD_PING_DISTACE ){
    //loop 1  
    while(!(Y_PING_DISTACE <= YD_PING_DISTACE)){
...
void bot_corner_fixer (){
  ...
  while(loop_flag){
    ...
    if( coordinate > 90 && coordinate < 150 ){
