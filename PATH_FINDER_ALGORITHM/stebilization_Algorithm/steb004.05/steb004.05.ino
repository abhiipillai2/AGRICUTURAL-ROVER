...
//step_1(choice)
  ...
  //temp store
  caliber_w1 = (Y_PING_DISTACE - 3);
  caliber_w2 = (YD_PING_DISTACE - 3);
  ...
  if(caliber_w1 < caliber_w01){
    ...
    int tempFix_W01 = 0;
    tempFix_W01 = (caliber_w1_sum / count );
    fixing_w01 = (tempFix_W01 - 9);
    delay(50);
  }
//*************************************************//
//*************************************************//
//fixing
    fixTemp_w01 = Y_PING_DISTACE;
    fixTemp_w02 = YD_PING_DISTACE;
      ...
      fixTemp_w1 = Y_PING_DISTACE;
      fixTemp_w2 = YD_PING_DISTACE;
      
        while(!(fixTemp_w1 <= fixing_w01)){
        //stop
        digitalWrite(M1_FORWARD,LOW);
        digitalWrite(M1_BACKWARD,LOW);
        ...
        YD_PING_DISTACE = sonar_YD.ping_cm();
        delay(1000);
        fixTemp_w1 = (Y_PING_DISTACE - 3);
        fixTemp_w2 = (YD_PING_DISTACE - 3);
        delay(50);
