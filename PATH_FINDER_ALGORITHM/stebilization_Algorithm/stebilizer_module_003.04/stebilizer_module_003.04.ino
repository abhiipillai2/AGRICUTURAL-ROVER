...
void bot_stebilizer (int X , int Y, int ornt){
  ...
  Serial.println("enter the stebilizer function");
  ...
  GLOBEL_X = 96;
  GLOBEL_Y = 70;
  Serial.println("ontn 1");
  }else if(ornt == 2){
  
  GLOBEL_X = 70;
  GLOBEL_Y = 96;
  Serial.println("ontn 2");
}
    ...
    Serial.println(DW);
        ...
        if(counter_flag){
          ...
          if(internal_y > ref_y || internal_y > ref_y + 5 || internal_y > ref_y + 10 || internal_y > ref_y + 15 || internal_y > ref_y + 20 ) {
              ...
              counter_flag = false; 
              ref_y = internal_y;
              Serial.println("counter_flag-false");
              Serial.println(ref_y);
          } 
        }else{
            ...
            if(internal_y > ref_y || internal_y > ref_y + 5 || internal_y > ref_y + 10 || internal_y > ref_y + 15 || internal_y > ref_y + 20 ){
              ...
              counter_flag = true;
              ref_y = internal_y;
              Serial.println("counter_flag-true");
              Serial.println(ref_y);
          }
        }
